            ...
            <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-sm space-y-6">
                <div>
                    ...
                    <div className="flex items-center space-x-4 mt-1">
                        <label className="flex items-center text-sm"><input type="radio" name="mode" value="Quantity Adjustment" checked={adjustment.mode === 'Quantity Adjustment'} onChange={handleInputChange} className="mr-2 h-4 w-4 text-primary-600 focus:ring-primary-500 border-gray-300" /> Quantity Adjustment</label>
                        <label className="flex items-center text-sm"><input type="radio" name="mode" value="Value Adjustment" checked={adjustment.mode === 'Value Adjustment'} onChange={handleInputChange} className="mr-2 h-4 w-4 text-primary-600 focus:ring-primary-500 border-gray-300" /> Value Adjustment</label>
                    </div>
                </div>
