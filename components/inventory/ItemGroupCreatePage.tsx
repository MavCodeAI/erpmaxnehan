...
import { Save, X, PlusCircle, Trash2, Upload, HelpCircle, ArrowDown, Package, Layers } from 'lucide-react';
        ...
        <>
            <div className="flex justify-between items-center my-6">
                <div>
                    ...
                    <p className="text-gray-600 dark:text-gray-400 mt-1">Create multiple item variants with different attributes</p>
                </div>
                <div className="flex space-x-2">
                    <Button variant="secondary" icon={X} onClick={() => navigate('/inventory/items')}>Cancel</Button>
                    <Button variant="primary" icon={Save} onClick={handleSave}>Save Group</Button>
                </div>
            </div>
                        ...
                        <div className="md:col-span-2 space-y-4">
                             <div>
                                ...
                                <div className="flex items-center space-x-4 mt-1">
                                    <label className="flex items-center text-sm"><input type="radio" name="itemType" value="Goods" checked={itemType === 'Goods'} onChange={(e) => setItemType(e.target.value as any)} className="mr-2 h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300" /> Goods</label>
                                    <label className="flex items-center text-sm"><input type="radio" name="itemType" value="Service" checked={itemType === 'Service'} onChange={(e) => setItemType(e.target.value as any)} className="mr-2 h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300" /> Service</label>
                                </div>
                            </div>
                            <div>
