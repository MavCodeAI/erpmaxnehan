      ...
      <div className="flex items-center gap-2">
        ...
        {onItemsPerPageChange && (
          <select
            ...
            className="px-2 py-1 text-sm border dark:border-gray-600 rounded-md bg-white dark:bg-gray-700 text-gray-700 dark:text-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500"
          >
