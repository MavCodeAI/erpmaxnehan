    ...
    <div ref={searchRef} className="relative w-full max-w-xl">
      <div className="relative">
        ...
        <input
          ...
          className="w-full pl-10 pr-10 py-2 text-sm text-gray-700 placeholder-gray-500 bg-gray-100 border-0 rounded-lg dark:placeholder-gray-400 dark:bg-gray-700 dark:text-gray-200 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:bg-white dark:focus:bg-gray-600"
        />
        {query && (
          <button
            onClick={() => {
