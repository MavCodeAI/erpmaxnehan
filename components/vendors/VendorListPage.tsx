...
const VendorListPage: React.FC<VendorListPageProps> = ({ vendors, onDelete }) => {
    ...
    const filteredVendors = useMemo(() => {
        ...
        return vendors.filter(vendor => {
            const displayName = (vendor.displayName || '').toString().toLowerCase();
            const companyName = (vendor.companyName || '').toString().toLowerCase();
            const email = (vendor.email || '').toString().toLowerCase();
            const workPhone = (vendor.workPhone || '').toString().toLowerCase();
