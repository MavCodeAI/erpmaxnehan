...
export interface InventoryItem {
  ...
  // Fixed: Added missing properties for compatibility
  price?: number; // For sales returns and purchase returns
  quantity?: number; // Current stock quantity
  current_stock?: number; // Alternative to quantity
  cost_price?: number; // Alternative to costPrice
  selling_price?: number; // Alternative to sellingPrice
