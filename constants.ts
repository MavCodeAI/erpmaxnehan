...
export const MOCK_INVENTORY_ITEMS = [
    {
        ...
        sellingPrice: 85000,
        salesAccountId: '10',
        salesDescription: 'High-performance laptop for business',
        trackPurchases: true,
        costPrice: 65000,
        purchaseAccountId: '12',
        purchaseDescription: 'Dell Inspiron 15 3000 Series',
        trackInventory: true,
        inventoryAccountId: '5',
        openingStock: 15,
        openingStockRate: 65000,
        reorderPoint: 5,
    },
    {
        id: '2',
        ...
        sellingPrice: 2500,
        salesAccountId: '10',
        salesDescription: 'Ergonomic wireless mouse',
        trackPurchases: true,
        costPrice: 1800,
        purchaseAccountId: '12',
        purchaseDescription: 'Logitech M331 Silent Plus',
        trackInventory: true,
        inventoryAccountId: '5',
        openingStock: 50,
    ...
    },
    {
        ...
        sellingPrice: 8500,
        salesAccountId: '10',
        salesDescription: 'Gaming mechanical keyboard with RGB',
        trackPurchases: true,
        costPrice: 6000,
        purchaseAccountId: '12',
        purchaseDescription: 'RGB Mechanical Gaming Keyboard',
        trackInventory: true,
        inventoryAccountId: '5',
        openingStock: 25,
        openingStockRate: 6000,
        reorderPoint: 8,
    },
    {
        id: '4',
        ...
        sellingPrice: 4500,
        salesAccountId: '10',
        salesDescription: '7-port USB-C hub with HDMI',
        trackPurchases: true,
        costPrice: 3200,
        purchaseAccountId: '12',
        purchaseDescription: 'Multi-port USB-C Hub',
        trackInventory: true,
        inventoryAccountId: '5',
        openingStock: 30,
        openingStockRate: 3200,
        reorderPoint: 10,
    },
    {
        id: '5',
        ...
        sellingPrice: 1500,
        salesAccountId: '10',
        salesDescription: 'Professional computer repair and maintenance',
...
export const MOCK_INVOICES = [
    {
        ...
        dueDate: '2025-02-04',
        items: [
            { id: '1', inventoryItemId: '1', description: 'Laptop Dell Inspiron 15', quantity: 2, price: 85000, discount: 5, tax: 0, total: 161500 },
            { id: '2', inventoryItemId: '2', description: 'Wireless Mouse Logitech', quantity: 2, price: 2500, discount: 0, tax: 0, total: 5000 },
        ],
        shippingCharges: 500,
        adjustment: -1000,
        total: 166000,
    ...
    },
    {
        ...
        dueDate: '2025-02-09',
        items: [
            { id: '1', inventoryItemId: '3', description: 'Mechanical Keyboard RGB', quantity: 5, price: 8500, discount: 10, tax: 0, total: 38250 },
            { id: '2', inventoryItemId: '4', description: 'USB-C Hub 7-in-1', quantity: 3, price: 4500, discount: 0, tax: 0, total: 13500 },
        ],
        shippingCharges: 300,
        adjustment: 0,
        total: 52050,
    ...
    },
    {
        ...
        dueDate: '2025-02-14',
        items: [
            { id: '1', inventoryItemId: '1', description: 'Laptop Dell Inspiron 15', quantity: 10, price: 85000, discount: 8, tax: 0, total: 782000 },
            { id: '2', inventoryItemId: '3', description: 'Mechanical Keyboard RGB', quantity: 10, price: 8500, discount: 8, tax: 0, total: 78200 },
            { id: '3', inventoryItemId: '2', description: 'Wireless Mouse Logitech', quantity: 10, price: 2500, discount: 8, tax: 0, total: 23000 },
        ],
...
// Demo Bills (Purchase Bills)
export const MOCK_BILLS = [
    {
        id: '1',
        billNumber: 'BILL-000001',
        vendorId: '1',
        vendorName: 'Tech Suppliers Co.',
        date: '2025-01-08',
        dueDate: '2025-02-07',
        items: [
            { id: '1', inventoryItemId: '1', description: 'Laptop Dell Inspiron 15', quantity: 20, price: 65000, total: 1300000 },
            { id: '2', inventoryItemId: '2', description: 'Wireless Mouse Logitech', quantity: 50, price: 1800, total: 90000 },
        ],
    ...
    },
    {
        ...
        dueDate: '2025-02-11',
        items: [
            { id: '1', inventoryItemId: '3', description: 'Mechanical Keyboard RGB', quantity: 30, price: 6000, total: 180000 },
            { id: '2', inventoryItemId: '4', description: 'USB-C Hub 7-in-1', quantity: 40, price: 3200, total: 128000 },
        ],
